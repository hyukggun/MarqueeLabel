//
//  LeftToRightMarqueeAnimationStrategy.swift
//
//
...
public struct LeftToRightMarqueeAnimationStrategy: MarqueeAnimationStrategy {
    ...
    private func homeOrigin(_ marqueeLabel: MarqueeLabel) -> Double {
        marqueeLabel.frame.minX + marqueeLabel.subLabel.frame.size.width  / 2
    }
